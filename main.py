...
DIGITS_FONTSTYLE = ('Arial', 24,'bold')
...
class Calculator:
    ...
    def create_digit_buttons(self):
        for digit,grid_value in self.digits.items():
            ...
            fg=LABEL_COLOR, font=DIGITS_FONTSTYLE,borderwidth=0, 
    ...
    def create_operator_buttons(self):
        ...
        for operator,symbol in self.operations.items():
            ...
            bg=OFF_WHITE, fg=LABEL_COLOR, font= DEFAULT_FONTSTYLE, borderwidth=0,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=WHITE, 
            fg=LABEL_COLOR, font=DIGITS_FONTSTYLE,borderwidth=0,
            command=self.square)
    ...
    def create_display_labels(self):
        total_label = tk.Label(self.display_frame, text=self.total_expression, 
            ...
            font=SMALL_FONT_STYLE) #padding and label colors
        total_label.pack(expand=True,fill='both')
        label = tk.Label(self.display_frame, text=self.total_expression, 
            anchor = tk.E, bg=LIGHT_GRAY,fg=LABEL_COLOR, padx=24,
            font=LARGE_FONT_STYLE) #padding and label colors
